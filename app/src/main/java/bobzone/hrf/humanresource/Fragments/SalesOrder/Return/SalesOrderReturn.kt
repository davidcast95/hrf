package bobzone.hrf.humanresource.Fragments.SalesOrder.Return
 ...
 */
open class SalesOrderReturn : SalesOrderBase() {
    ...
    override fun getAPIHandlingOnBaseMessage(query: String, page: Int): Call<BaseMessage<SalesOrderData>>? {
        ...
        return api.getSalesOrder(SalesOrderStatus.instance.CANCELLED,query,"$start")
    }
